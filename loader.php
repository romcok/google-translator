...
FALSE;}$rule->control->addError(vsprintf($rule->control->translate($rule->message,is_int($rule->arg)?$rule->arg:NULL),(array)$rule->arg));$valid=FALSE;if($rule->breakOnFailure){break;}}}return$valid;}final
function
getIterator(){return
new
